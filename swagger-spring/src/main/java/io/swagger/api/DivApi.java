...
public interface DivApi {
    ...
    @ApiOperation(value = "", nickname = "divABGet", notes = "", response = Result.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Result> divABGet(@ApiParam(value = "",required=true) @PathVariable("a") String a,@ApiParam(value = "",required=true) @PathVariable("b") String b);

...
public interface SubApi {
    ...
    @ApiOperation(value = "", nickname = "subABGet", notes = "", response = Result.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Result> subABGet(@ApiParam(value = "",required=true) @PathVariable("a") String a,@ApiParam(value = "",required=true) @PathVariable("b") String b);

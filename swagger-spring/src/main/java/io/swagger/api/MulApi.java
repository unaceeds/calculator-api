...
public interface MulApi {
    ...
    @ApiOperation(value = "", nickname = "mulABGet", notes = "", response = Result.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Result> mulABGet(@ApiParam(value = "",required=true) @PathVariable("a") String a,@ApiParam(value = "",required=true) @PathVariable("b") String b);
